    ...
    talents: [
      {
        name: 'Arms', school: 'physical', color: '#e0714f', nodes: [
          ...
          { id: 'w_a7', name: 'Mortal Strike', desc: 'Bleeds you apply tick 12% harder per rank.', max: 5, effect: { bleedPct: 0.12 } },
          { id: 'w_a8', name: 'Sweeping Blows', desc: '+7% area radius and +4% melee damage per rank.', max: 5, effect: { aoeRadius: 0.07, meleeDamage: 0.04 } },
          { id: 'w_a9', name: 'Sudden Death', desc: '+4% crit and +8% crit damage per rank.', max: 5, effect: { critChance: 0.04, critMult: 0.08 } },
          { id: 'w_a10', name: 'Warbringer', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'w_a11', name: 'Colossus Smash', desc: '+30% damage to bosses and +10% melee damage.', max: 1, effect: { bossDamage: 0.30, meleeDamage: 0.10 } },
        ],
      },
      {
        name: 'Fury', school: 'physical', color: '#ff9d5c', nodes: [
          ...
          { id: 'w_f7', name: 'Bloodthirst', desc: '+2.5% lifesteal and +18 max health per rank.', max: 5, effect: { lifesteal: 0.025, maxHp: 18 } },
          { id: 'w_f8', name: 'Enrage', desc: '+5% damage while below a third health, per rank.', max: 5, effect: { allDamage: 0.05 } },
          { id: 'w_f9', name: 'Meat Cleaver', desc: '+6% attack speed and +5% area per rank.', max: 5, effect: { attackSpeed: 0.06, aoeRadius: 0.05 } },
          { id: 'w_f10', name: 'Recklessness', desc: 'Swing for the fences: heavier crits, every rank.', max: 4, effect: { critMult: 0.06 } },
          { id: 'w_f11', name: 'Titan\'s Grip', desc: '+18% melee damage and +12% attack speed.', max: 1, effect: { meleeDamage: 0.18, attackSpeed: 0.12 } },
        ],
      },
      {
        name: 'Protection', school: 'frost', color: '#8fb3ff', nodes: [
          ...
          { id: 'w_p7', name: 'Shield Mastery', desc: '+2% armor and +14 max health per rank.', max: 6, effect: { armor: 0.02, maxHp: 14 } },
          { id: 'w_p8', name: 'Revenge', desc: 'Reflect 8% more damage and gain 2 Rage per hit taken, per rank.', max: 5, effect: { thorns: 0.08, onHitGain: 2 } },
          { id: 'w_p9', name: 'Bulwark', desc: '-2% damage taken per rank.', max: 5, effect: { damageReduction: 0.02 } },
          { id: 'w_p10', name: 'Impending Victory', desc: 'Restore 10 health per kill per rank.', max: 5, effect: { killHeal: 10 } },
          { id: 'w_p11', name: 'Unbreakable', desc: 'Survive one lethal hit a run at 45% health.', max: 1, effect: { cheatDeathRun: 0.45 } },
        ],
      },
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          { id: 'w_m1', name: 'Unstoppable Charge', skill: 'charge', desc: 'Charge hits harder and reaches 12% further, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'w_m3', name: 'Bloodletting', skill: 'rend', desc: 'Rend bleeds harder and 1s longer, per rank.', max: 5, effect: { skillDamage: 0.09, skillDuration: 1 } },
          ...
          { id: 'w_m6', name: 'Thunderlord', skill: 'thunderclap', desc: 'Thunder Clap starts at rank 3, reaches 25% wider and hits harder.', max: 1, effect: { startRank: 3, skillRadius: 0.25, skillDamage: 0.10 } },
          { id: 'w_m7', name: 'Leap of Faith', skill: 'heroicleap', desc: 'Heroic Leap hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.07, skillRadius: 0.12 } },
          { id: 'w_m8', name: 'Warlord\'s Voice', skill: 'battlecry', desc: 'Battle Cry lasts 1.5s longer and its cooldown drops 8%, per rank.', max: 4, effect: { skillDuration: 1.5, skillCooldown: 0.08 } },
          { id: 'w_m9', name: 'Whirling Death', skill: 'bladestorm', desc: 'Bladestorm hits harder and reaches 14% further, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.14 } },
          { id: 'w_m10', name: 'Titanic Form', skill: 'avatar', desc: 'Avatar lasts 2s longer and costs 12% less, per rank.', max: 4, effect: { skillDuration: 2, skillCost: 0.12 } },
          { id: 'w_m11', name: 'Fault Line', skill: 'shockwave', desc: 'Shockwave starts at rank 3 and reaches 25% further.', max: 1, effect: { startRank: 3, skillRadius: 0.25 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Fire', school: 'fire', color: '#ff8a3c', nodes: [
          ...
          { id: 'm_f7', name: 'Ignite', desc: 'Burns tick 14% harder per rank.', max: 5, effect: { burnDamage: 0.14 } },
          { id: 'm_f8', name: 'Combustion', desc: '+4% crit and +10% crit damage per rank.', max: 5, effect: { critChance: 0.04, critMult: 0.10 } },
          { id: 'm_f9', name: 'Living Bomb', desc: '+8% area radius per rank.', max: 5, effect: { aoeRadius: 0.08 } },
          { id: 'm_f10', name: 'Pyromaniac', desc: 'Crits cut every cooldown by 0.35s per rank.', max: 4, effect: { critCdr: 0.35 } },
          { id: 'm_f11', name: 'Firelord', desc: '+20% spell damage and +15% burn damage.', max: 1, effect: { spellDamage: 0.20, burnDamage: 0.15 } },
        ],
      },
      {
        name: 'Frost', school: 'frost', color: '#8fe3ff', nodes: [
          ...
          { id: 'm_i7', name: 'Shatter', desc: '+5% damage against frozen targets per rank.', max: 5, effect: { frozenDamage: 0.05 } },
          { id: 'm_i8', name: 'Ice Barrier', desc: '+6 absorb and +12 max health per rank.', max: 5, effect: { absorb: 6, maxHp: 12 } },
          { id: 'm_i9', name: 'Frozen Veins', desc: 'Slows you apply last 0.6s longer per rank.', max: 4, effect: { applySlow: 0.06 } },
          { id: 'm_i10', name: 'Cold Snap', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'm_i11', name: 'Absolute Zero', desc: '+16% spell damage and -8% damage taken.', max: 1, effect: { spellDamage: 0.16, damageReduction: 0.08 } },
        ],
      },
      {
        name: 'Arcane', school: 'arcane', color: '#c98fff', nodes: [
          ...
          { id: 'm_a7', name: 'Arcane Power', desc: '+5% spell damage per rank.', max: 6, effect: { spellDamage: 0.05 } },
          { id: 'm_a8', name: 'Clearcasting', desc: 'Skills cost 7% less per rank.', max: 5, effect: { costReduction: 0.07 } },
          { id: 'm_a9', name: 'Presence of Mind', desc: '+12 max mana and +1.2 mana regen per rank.', max: 5, effect: { resourceMax: 12, resourceRegen: 1.2 } },
          { id: 'm_a10', name: 'Missile Barrage', desc: '+1 extra projectile per rank.', max: 2, effect: { extraProjectiles: 1 } },
          { id: 'm_a11', name: 'Arcane Mastery', desc: '+15% spell damage, -10% cooldowns.', max: 1, effect: { spellDamage: 0.15, cooldownReduction: 0.10 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'm_m4', name: 'Perpetual Blizzard', skill: 'blizzard', desc: 'Blizzard lasts 1.2s longer and ticks harder, per rank.', max: 4, effect: { skillDuration: 1.2, skillDamage: 0.08 } },
          ...
          { id: 'm_m6', name: 'Sun King', skill: 'pyroblast', desc: 'Pyroblast starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.14 } },
          { id: 'm_m7', name: 'Orbital Decay', skill: 'arcaneorb', desc: 'Arcane Orb hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'm_m8', name: 'Conflagration', skill: 'flamestrike', desc: 'Flamestrike burns harder and 1s longer, per rank.', max: 4, effect: { skillDamage: 0.08, skillDuration: 1 } },
          { id: 'm_m9', name: 'Temporal Flux', skill: 'timewarp', desc: 'Time Warp lasts 1.5s longer and its cooldown drops 9%, per rank.', max: 4, effect: { skillDuration: 1.5, skillCooldown: 0.09 } },
          { id: 'm_m10', name: 'Frozen Heart', skill: 'iceblock', desc: 'Ice Block lasts 1.2s longer and costs 14% less, per rank.', max: 4, effect: { skillDuration: 1.2, skillCost: 0.14 } },
          { id: 'm_m11', name: 'Deep Freeze', skill: 'frostbolt', desc: 'Frostbolt starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Affliction', school: 'shadow', color: '#8f4dff', nodes: [
          ...
          { id: 'k_a7', name: 'Unstable Affliction', desc: '+9% damage over time per rank.', max: 6, effect: { dotDamage: 0.09 } },
          { id: 'k_a8', name: 'Pandemic', desc: 'Your dots last 0.5s longer per rank.', max: 5, effect: { dotDuration: 0.5 } },
          { id: 'k_a9', name: 'Siphon Life', desc: 'Heal 2.5% of dot damage per rank.', max: 5, effect: { dotLifesteal: 0.025 } },
          { id: 'k_a10', name: 'Nightfall', desc: '+4% crit and +6% spell damage per rank.', max: 4, effect: { critChance: 0.04, spellDamage: 0.06 } },
          { id: 'k_a11', name: 'Soul Rot', desc: '+22% damage over time and +6% lifesteal.', max: 1, effect: { dotDamage: 0.22, lifesteal: 0.06 } },
        ],
      },
      {
        name: 'Demonology', school: 'shadow', color: '#ff6bb5', nodes: [
          ...
          { id: 'k_d7', name: 'Demonic Knowledge', desc: '+8% pet power per rank.', max: 6, effect: { petPower: 0.08 } },
          { id: 'k_d8', name: 'Master Summoner', desc: '+1 demon at a time.', max: 1, effect: { maxPets: 1 } },
          { id: 'k_d9', name: 'Fel Vitality', desc: '+16 max health and +8 max shards per rank.', max: 5, effect: { maxHp: 16, resourceMax: 8 } },
          { id: 'k_d10', name: 'Soul Link', desc: '-2.5% damage taken per rank.', max: 5, effect: { damageReduction: 0.025 } },
          { id: 'k_d11', name: 'Demonic Pact', desc: '+25% pet power and +12% all damage.', max: 1, effect: { petPower: 0.25, allDamage: 0.12 } },
        ],
      },
      {
        name: 'Destruction', school: 'fire', color: '#ff8a3c', nodes: [
          ...
          { id: 'k_s7', name: 'Devastation', desc: '+5% spell damage per rank.', max: 6, effect: { spellDamage: 0.05 } },
          { id: 'k_s8', name: 'Shadowburn', desc: 'Execute threshold +7% per rank.', max: 4, effect: { executeThreshold: 0.07 } },
          { id: 'k_s9', name: 'Cataclysm', desc: '+8% area radius per rank.', max: 5, effect: { aoeRadius: 0.08 } },
          { id: 'k_s10', name: 'Backdraft', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'k_s11', name: 'Chaos Incarnate', desc: '+18% spell damage and +12% crit damage.', max: 1, effect: { spellDamage: 0.18, critMult: 0.12 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          { id: 'k_m1', name: 'Festering Corruption', skill: 'corruption', desc: 'Corruption ticks harder and lasts 1s longer, per rank.', max: 6, effect: { skillDamage: 0.09, skillDuration: 1 } },
          ...
          { id: 'k_m3', name: 'Greater Fiend', skill: 'summonimp', desc: 'Your Fiend is stronger and arrives 10% sooner, per rank.', max: 5, effect: { skillDamage: 0.09, skillCooldown: 0.10 } },
          ...
          { id: 'k_m5', name: 'Unstable Mind', skill: 'unstable', desc: 'Unstable Affliction hits harder and costs 10% less, per rank.', max: 4, effect: { skillDamage: 0.10, skillCost: 0.10 } },
          { id: 'k_m6', name: 'Lord of Chaos', skill: 'chaosbolt', desc: 'Chaos Bolt starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
          { id: 'k_m7', name: 'Rupture', skill: 'shadowfury', desc: 'Shadowfury hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'k_m8', name: 'Terrify', skill: 'howl', desc: 'Howl of Terror lasts 1.5s longer and costs 12% less, per rank.', max: 4, effect: { skillDuration: 1.5, skillCost: 0.12 } },
          { id: 'k_m9', name: 'Reaping', skill: 'soulharvest', desc: 'Soul Harvest lasts 2s longer and its cooldown drops 8%, per rank.', max: 4, effect: { skillDuration: 2, skillCooldown: 0.08 } },
          { id: 'k_m10', name: 'Wider Gate', skill: 'demongate', desc: 'Demonic Gateway costs 14% less and its cooldown drops 9%, per rank.', max: 4, effect: { skillCost: 0.14, skillCooldown: 0.09 } },
          { id: 'k_m11', name: 'Green Fire', skill: 'felflame', desc: 'Fel Flame starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Elemental', school: 'storm', color: '#7ef0ff', nodes: [
          ...
          { id: 's_e7', name: 'Concussion', desc: '+5% spell damage per rank.', max: 6, effect: { spellDamage: 0.05 } },
          { id: 's_e8', name: 'Elemental Focus', desc: 'Skills cost 7% less per rank.', max: 5, effect: { costReduction: 0.07 } },
          { id: 's_e9', name: 'Lightning Mastery', desc: 'Chains jump once further per rank.', max: 2, effect: { jumps: 1 } },
          { id: 's_e10', name: 'Elemental Fury', desc: '+9% crit damage per rank.', max: 5, effect: { critMult: 0.09 } },
          { id: 's_e11', name: 'Stormkeeper', desc: '+16% spell damage and +10% area.', max: 1, effect: { spellDamage: 0.16, aoeRadius: 0.10 } },
        ],
      },
      {
        name: 'Enhancement', school: 'physical', color: '#ffd98a', nodes: [
          ...
          { id: 's_h7', name: 'Flurry', desc: '+6% attack speed per rank.', max: 5, effect: { attackSpeed: 0.06 } },
          { id: 's_h8', name: 'Unleashed Rage', desc: '+5% melee damage per rank.', max: 6, effect: { meleeDamage: 0.05 } },
          { id: 's_h9', name: 'Shamanistic Rage', desc: 'Heal 2.5% of damage dealt per rank.', max: 5, effect: { lifesteal: 0.025 } },
          { id: 's_h10', name: 'Spirit Walk', desc: '+3% move speed and +2% dodge per rank.', max: 5, effect: { moveSpeed: 0.03, dodge: 0.02 } },
          { id: 's_h11', name: 'Feral Spirit', desc: '+18% melee damage and +14% attack speed.', max: 1, effect: { meleeDamage: 0.18, attackSpeed: 0.14 } },
        ],
      },
      {
        name: 'Restoration', school: 'nature', color: '#9dffe0', nodes: [
          ...
          { id: 's_r7', name: 'Purification', desc: '+6% healing per rank.', max: 5, effect: { healing: 0.06 } },
          { id: 's_r8', name: 'Totemic Focus', desc: 'Totems last 1.2s longer per rank.', max: 5, effect: { totemDuration: 1.2 } },
          { id: 's_r9', name: 'Earth Shield', desc: '+7 absorb and +14 max health per rank.', max: 5, effect: { absorb: 7, maxHp: 14 } },
          { id: 's_r10', name: 'Nature\'s Guardian', desc: 'Restore 9 health per kill per rank.', max: 5, effect: { killHeal: 9 } },
          { id: 's_r11', name: 'Ancestral Guidance', desc: '+20% healing and -8% damage taken.', max: 1, effect: { healing: 0.20, damageReduction: 0.08 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 's_m3', name: 'Enduring Totem', skill: 'searingtotem', desc: 'Your Searing Totem lasts 2s longer and hits harder, per rank.', max: 5, effect: { skillDuration: 2, skillDamage: 0.08 } },
          { id: 's_m4', name: 'Wellspring', skill: 'healingtotem', desc: 'Your Healing Totem lasts 2s longer and mends more, per rank.', max: 4, effect: { skillDuration: 2, skillDamage: 0.07 } },
          ...
          { id: 's_m6', name: 'Elemental Fury', skill: 'elementalblast', desc: 'Elemental Blast starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
          { id: 's_m7', name: 'Fracture', skill: 'earthshock', desc: 'Earth Shock hits harder and costs 12% less, per rank.', max: 4, effect: { skillDamage: 0.08, skillCost: 0.12 } },
          { id: 's_m8', name: 'Thunderfist', skill: 'stormstrike', desc: 'Stormstrike hits harder and its cooldown drops 8%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.08 } },
          { id: 's_m9', name: 'Swift Spirit', skill: 'ghostwolf', desc: 'Spirit Wolf lasts 1.5s longer and costs 14% less, per rank.', max: 4, effect: { skillDuration: 1.5, skillCost: 0.14 } },
          { id: 's_m10', name: 'Bound Souls', skill: 'spiritlink', desc: 'Spirit Link lasts 2s longer and its cooldown drops 9%, per rank.', max: 4, effect: { skillDuration: 2, skillCooldown: 0.09 } },
          { id: 's_m11', name: 'Permafrost', skill: 'frostshock', desc: 'Frost Shock starts at rank 3 and slows 25% further.', max: 1, effect: { startRank: 3, skillRadius: 0.25 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Holy', school: 'holy', color: '#ffe9a8', nodes: [
          ...
          { id: 'p_h7', name: 'Spiritual Healing', desc: '+6% healing per rank.', max: 5, effect: { healing: 0.06 } },
          { id: 'p_h8', name: 'Divine Fury', desc: '+5% spell damage per rank.', max: 6, effect: { spellDamage: 0.05 } },
          { id: 'p_h9', name: 'Blessed Resilience', desc: '+16 max health and +2% armor per rank.', max: 5, effect: { maxHp: 16, armor: 0.02 } },
          { id: 'p_h10', name: 'Holy Concentration', desc: '+1.4 mana regen per rank.', max: 5, effect: { resourceRegen: 1.4 } },
          { id: 'p_h11', name: 'Divine Favour', desc: '+22% healing and +10% spell damage.', max: 1, effect: { healing: 0.22, spellDamage: 0.10 } },
        ],
      },
      {
        name: 'Discipline', school: 'arcane', color: '#bcd4ff', nodes: [
          ...
          { id: 'p_d7', name: 'Mental Agility', desc: 'Skills cost 7% less per rank.', max: 5, effect: { costReduction: 0.07 } },
          { id: 'p_d8', name: 'Power Infusion', desc: '+5% all damage per rank.', max: 5, effect: { allDamage: 0.05 } },
          { id: 'p_d9', name: 'Grace', desc: '+8 absorb per rank.', max: 6, effect: { absorb: 8 } },
          { id: 'p_d10', name: 'Borrowed Time', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'p_d11', name: 'Rapture', desc: '+18% healing, +12 absorb and -8% damage taken.', max: 1, effect: { healing: 0.18, absorb: 12, damageReduction: 0.08 } },
        ],
      },
      {
        name: 'Shadow', school: 'shadow', color: '#9a7fd8', nodes: [
          ...
          { id: 'p_s7', name: 'Shadow Weaving', desc: '+9% damage over time per rank.', max: 6, effect: { dotDamage: 0.09 } },
          { id: 'p_s8', name: 'Improved Mind Blast', desc: '+4% crit and +6% spell damage per rank.', max: 5, effect: { critChance: 0.04, spellDamage: 0.06 } },
          { id: 'p_s9', name: 'Vampiric Embrace', desc: 'Heal 2.5% of dot damage per rank.', max: 5, effect: { dotLifesteal: 0.025 } },
          { id: 'p_s10', name: 'Misery', desc: 'Your dots last 0.5s longer per rank.', max: 5, effect: { dotDuration: 0.5 } },
          { id: 'p_s11', name: 'Shadowform', desc: '+20% spell damage and +15% damage over time.', max: 1, effect: { spellDamage: 0.20, dotDamage: 0.15 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'p_m3', name: 'Renewed Hope', skill: 'renew', desc: 'Renew mends more and lasts 1.5s longer, per rank.', max: 5, effect: { skillDamage: 0.08, skillDuration: 1.5 } },
          { id: 'p_m4', name: 'Divine Radiance', skill: 'holynova', desc: 'Holy Nova reaches 15% wider and hits harder, per rank.', max: 4, effect: { skillRadius: 0.15, skillDamage: 0.08 } },
          { id: 'p_m5', name: 'Twisted Thoughts', skill: 'mindblast', desc: 'Mind Blast hits harder and its cooldown drops 10%, per rank.', max: 4, effect: { skillDamage: 0.09, skillCooldown: 0.10 } },
          { id: 'p_m6', name: 'Voice of the Void', skill: 'mindsear', desc: 'Mind Sear starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
          { id: 'p_m7', name: 'Guiding Star', skill: 'divinestar', desc: 'Divine Star hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'p_m8', name: 'Deeper Void', skill: 'voidform', desc: 'Void Form lasts 2s longer and its cooldown drops 8%, per rank.', max: 4, effect: { skillDuration: 2, skillCooldown: 0.08 } },
          { id: 'p_m9', name: 'Sanctify', skill: 'holyword', desc: 'Holy Word heals more and reaches 12% further, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'p_m10', name: 'Terrify', skill: 'psychicscream', desc: 'Psychic Scream costs 14% less and its cooldown drops 9%, per rank.', max: 4, effect: { skillCost: 0.14, skillCooldown: 0.09 } },
          { id: 'p_m11', name: 'Lingering Pain', skill: 'shadowword', desc: 'Shadow Word: Pain starts at rank 3 and lasts 2s longer.', max: 1, effect: { startRank: 3, skillDuration: 2 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Assassination', school: 'nature', color: '#8ce06a', nodes: [
          ...
          { id: 'r_a7', name: 'Vile Poisons', desc: '+9% damage over time per rank.', max: 6, effect: { dotDamage: 0.09 } },
          { id: 'r_a8', name: 'Cold Blood', desc: '+8% crit damage per rank.', max: 5, effect: { critMult: 0.08 } },
          { id: 'r_a9', name: 'Murder', desc: '+5% all damage per rank.', max: 5, effect: { allDamage: 0.05 } },
          { id: 'r_a10', name: 'Ruthlessness', desc: 'Crits cut every cooldown by 0.4s per rank.', max: 4, effect: { critCdr: 0.4 } },
          { id: 'r_a11', name: 'Master Poisoner', desc: '+20% damage over time and +5% lifesteal.', max: 1, effect: { dotDamage: 0.20, lifesteal: 0.05 } },
        ],
      },
      {
        name: 'Combat', school: 'physical', color: '#ffd24a', nodes: [
          ...
          { id: 'r_c7', name: 'Lightning Reflexes', desc: '+2.5% dodge per rank.', max: 5, effect: { dodge: 0.025 } },
          { id: 'r_c8', name: 'Blade Twisting', desc: '+6% attack speed per rank.', max: 5, effect: { attackSpeed: 0.06 } },
          { id: 'r_c9', name: 'Aggression', desc: '+5% melee damage per rank.', max: 6, effect: { meleeDamage: 0.05 } },
          { id: 'r_c10', name: 'Adrenaline', desc: '+14 max energy and +2 energy regen per rank.', max: 5, effect: { resourceMax: 14, resourceRegen: 2 } },
          { id: 'r_c11', name: 'Killing Spree', desc: '+16% melee damage and +12% attack speed.', max: 1, effect: { meleeDamage: 0.16, attackSpeed: 0.12 } },
        ],
      },
      {
        name: 'Subtlety', school: 'shadow', color: '#9fd8ff', nodes: [
          ...
          { id: 'r_s7', name: 'Opportunity', desc: 'Execute threshold +7% per rank.', max: 4, effect: { executeThreshold: 0.07 } },
          { id: 'r_s8', name: 'Serrated Blades', desc: 'Bleeds tick 12% harder per rank.', max: 5, effect: { bleedPct: 0.12 } },
          { id: 'r_s9', name: 'Elusiveness', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'r_s10', name: 'Sleight of Hand', desc: '+3% move speed and +2% dodge per rank.', max: 5, effect: { moveSpeed: 0.03, dodge: 0.02 } },
          { id: 'r_s11', name: 'Shadowstrike', desc: '+15% crit chance and +25% crit damage.', max: 1, effect: { critChance: 0.15, critMult: 0.25 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          { id: 'r_m1', name: 'Perfected Ambush', skill: 'ambush', desc: 'Ambush hits harder and costs 12% less, per rank.', max: 6, effect: { skillDamage: 0.08, skillCost: 0.12 } },
          { id: 'r_m2', name: 'Whirling Steel', skill: 'fanofknives', desc: 'Fan of Knives reaches 14% wider and hits harder, per rank.', max: 5, effect: { skillRadius: 0.14, skillDamage: 0.07 } },
          { id: 'r_m3', name: 'Deeper Cuts', skill: 'eviscerate', desc: 'Eviscerate hits harder and its cooldown drops 9%, per rank.', max: 5, effect: { skillDamage: 0.09, skillCooldown: 0.09 } },
          ...
          { id: 'r_m6', name: 'Bloodbath', skill: 'crimsontempest', desc: 'Crimson Tempest starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
          { id: 'r_m7', name: 'Fan of Knives', skill: 'shuriken', desc: 'Shuriken Toss hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'r_m8', name: 'Deeper Shadows', skill: 'shadowdance', desc: 'Shadow Dance lasts 1.5s longer and its cooldown drops 8%, per rank.', max: 4, effect: { skillDuration: 1.5, skillCooldown: 0.08 } },
          { id: 'r_m9', name: 'Whirling Steel', skill: 'bladeflurry', desc: 'Blade Flurry lasts 2s longer and costs 12% less, per rank.', max: 4, effect: { skillDuration: 2, skillCost: 0.12 } },
          { id: 'r_m10', name: 'Vanish', skill: 'cloak', desc: 'Cloak of Shadows lasts 1.2s longer and its cooldown drops 9%, per rank.', max: 4, effect: { skillDuration: 1.2, skillCooldown: 0.09 } },
          { id: 'r_m11', name: 'Find Weakness', skill: 'backstab', desc: 'Backstab starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Havoc', school: 'fire', color: '#7dff5a', nodes: [
          ...
          { id: 'd_h7', name: 'Demonic Appetite', desc: 'Heal 2.5% of damage dealt per rank.', max: 5, effect: { lifesteal: 0.025 } },
          { id: 'd_h8', name: 'Momentum', desc: '+3% move speed and +4% damage per rank.', max: 5, effect: { moveSpeed: 0.03, allDamage: 0.04 } },
          { id: 'd_h9', name: 'First Blood', desc: '+6% melee damage per rank.', max: 5, effect: { meleeDamage: 0.06 } },
          { id: 'd_h10', name: 'Unbound Chaos', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'd_h11', name: 'Metamorphosis', desc: '+18% all damage and +12% attack speed.', max: 1, effect: { allDamage: 0.18, attackSpeed: 0.12 } },
        ],
      },
      {
        name: 'Vengeance', school: 'shadow', color: '#ff5a3c', nodes: [
          ...
          { id: 'd_v7', name: 'Soul Rending', desc: '+16 max health and +2% lifesteal per rank.', max: 5, effect: { maxHp: 16, lifesteal: 0.02 } },
          { id: 'd_v8', name: 'Charred Flesh', desc: 'Reflect 9% of damage taken per rank.', max: 5, effect: { thorns: 0.09 } },
          { id: 'd_v9', name: 'Demon Spikes', desc: '+2.5% armor per rank.', max: 5, effect: { armor: 0.025 } },
          { id: 'd_v10', name: 'Feast of Souls', desc: 'Restore 11 health per kill per rank.', max: 5, effect: { killHeal: 11 } },
          { id: 'd_v11', name: 'Last Resort', desc: 'Survive one lethal hit a run at 40% health.', max: 1, effect: { cheatDeathRun: 0.40 } },
        ],
      },
      {
        name: 'Felblood', school: 'nature', color: '#a35cff', nodes: [
          ...
          { id: 'd_f7', name: 'Burning Hatred', desc: '+3 Hatred per hit landed, per rank.', max: 4, effect: { onHitGain: 3 } },
          { id: 'd_f8', name: 'Chaos Brand', desc: '+5% all damage per rank.', max: 6, effect: { allDamage: 0.05 } },
          { id: 'd_f9', name: 'Fel Barrage', desc: '+8% area radius per rank.', max: 5, effect: { aoeRadius: 0.08 } },
          { id: 'd_f10', name: 'Cycle of Binding', desc: 'Skills cost 7% less per rank.', max: 5, effect: { costReduction: 0.07 } },
          { id: 'd_f11', name: 'Fel Devastation', desc: '+20% all damage and +8% lifesteal.', max: 1, effect: { allDamage: 0.20, lifesteal: 0.08 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          { id: 'd_m1', name: 'Momentum', skill: 'felrush', desc: 'Fel Rush hits harder and its cooldown drops 10%, per rank.', max: 6, effect: { skillDamage: 0.08, skillCooldown: 0.10 } },
          { id: 'd_m2', name: 'Burning Aura', skill: 'immolation', desc: 'Immolation Aura reaches 15% wider and burns harder, per rank.', max: 5, effect: { skillRadius: 0.15, skillDamage: 0.08 } },
          ...
          { id: 'd_m4', name: 'Burning Sigil', skill: 'sigilofflame', desc: 'Sigil of Flame lasts 1.5s longer and burns harder, per rank.', max: 4, effect: { skillDuration: 1.5, skillDamage: 0.08 } },
          { id: 'd_m5', name: 'Blind Fury', skill: 'eyebeam', desc: 'Eye Beam hits harder and its cooldown drops 9%, per rank.', max: 4, effect: { skillDamage: 0.09, skillCooldown: 0.09 } },
          ...
          { id: 'd_m7', name: 'Rending Glaive', skill: 'glaivethrow', desc: 'Throw Glaive hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'd_m8', name: 'Wider Nova', skill: 'chaosnova', desc: 'Chaos Nova reaches 14% further and costs 12% less, per rank.', max: 4, effect: { skillRadius: 0.14, skillCost: 0.12 } },
          { id: 'd_m9', name: 'Fel Wave', skill: 'feldevastation', desc: 'Fel Devastation hits harder and its cooldown drops 8%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.08 } },
          { id: 'd_m10', name: 'Deeper Dark', skill: 'darkness', desc: 'Darkness lasts 2s longer and reaches 12% further, per rank.', max: 4, effect: { skillDuration: 2, skillRadius: 0.12 } },
          { id: 'd_m11', name: 'Cleave the Weak', skill: 'shear', desc: 'Shear starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Retribution', school: 'holy', color: '#ffd98a', nodes: [
          ...
          { id: 'l_r7', name: 'Crusade', desc: '+5% melee damage per rank.', max: 6, effect: { meleeDamage: 0.05 } },
          { id: 'l_r8', name: 'Sanctity', desc: '+4% crit and +7% crit damage per rank.', max: 5, effect: { critChance: 0.04, critMult: 0.07 } },
          { id: 'l_r9', name: 'Divine Purpose', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'l_r10', name: 'Zeal', desc: '+6% attack speed per rank.', max: 5, effect: { attackSpeed: 0.06 } },
          { id: 'l_r11', name: 'Avenging Wrath', desc: '+18% melee damage and +12% healing.', max: 1, effect: { meleeDamage: 0.18, healing: 0.12 } },
        ],
      },
      {
        name: 'Protection', school: 'frost', color: '#8fb3ff', nodes: [
          ...
          { id: 'l_p4', name: 'Ardent Defender', desc: 'Survive a lethal hit once per wave at 25% hp.', max: 1, effect: { cheatDeath: 1 } },
          ...
          { id: 'l_p7', name: 'Redoubt', desc: '+2.5% armor per rank.', max: 6, effect: { armor: 0.025 } },
          { id: 'l_p8', name: 'Ardent Defender', desc: '-2.5% damage taken per rank.', max: 5, effect: { damageReduction: 0.025 } },
          { id: 'l_p9', name: 'Reckoning', desc: 'Reflect 9% of damage taken per rank.', max: 5, effect: { thorns: 0.09 } },
          { id: 'l_p10', name: 'Guarded by the Light', desc: '+20 max health and +2 Faith per hit taken, per rank.', max: 5, effect: { maxHp: 20, onHitGain: 2 } },
          { id: 'l_p11', name: 'Aegis', desc: '+10% max health, +12 absorb and -6% damage taken.', max: 1, effect: { maxHpPct: 0.10, absorb: 12, damageReduction: 0.06 } },
        ],
      },
      {
        name: 'Holy', school: 'holy', color: '#ffe9a8', nodes: [
          ...
          { id: 'l_h7', name: 'Illumination', desc: '+6% healing per rank.', max: 5, effect: { healing: 0.06 } },
          { id: 'l_h8', name: 'Holy Power', desc: '+5% spell damage per rank.', max: 5, effect: { spellDamage: 0.05 } },
          { id: 'l_h9', name: 'Sacred Cleansing', desc: '+8 absorb per rank.', max: 6, effect: { absorb: 8 } },
          { id: 'l_h10', name: 'Light\'s Grace', desc: '+1.3 Faith regen per rank.', max: 5, effect: { resourceRegen: 1.3 } },
          { id: 'l_h11', name: 'Beacon of Light', desc: '+22% healing and +10% max health.', max: 1, effect: { healing: 0.22, maxHpPct: 0.10 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four. It is the branch that makes the loadout
      ...
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          { id: 'l_m1', name: 'Zealous Strike', skill: 'crusaderstrike', desc: 'Crusader Strike hits harder and costs 12% less, per rank.', max: 6, effect: { skillDamage: 0.07, skillCost: 0.12 } },
          { id: 'l_m2', name: 'Hallowed Ground', skill: 'consecration', desc: 'Consecration lasts 1.5s longer and burns harder, per rank.', max: 5, effect: { skillDuration: 1.5, skillDamage: 0.08 } },
          ...
          { id: 'l_m6', name: 'Eternal Flame', skill: 'divinestorm', desc: 'Divine Storm starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
          { id: 'l_m7', name: 'Hands of Mercy', skill: 'layonhands', desc: 'Lay on Hands heals more and its cooldown drops 9%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.09 } },
          { id: 'l_m8', name: 'Ricochet', skill: 'avengershield', desc: 'Avenger\'s Shield hits harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'l_m9', name: 'Greater Blessing', skill: 'blessing', desc: 'Blessing of Might lasts 2s longer and costs 12% less, per rank.', max: 4, effect: { skillDuration: 2, skillCost: 0.12 } },
          { id: 'l_m10', name: 'Wings', skill: 'avengingwrath', desc: 'Avenging Wrath lasts 1.5s longer and its cooldown drops 8%, per rank.', max: 4, effect: { skillDuration: 1.5, skillCooldown: 0.08 } },
          { id: 'l_m11', name: 'Hammer of the Just', skill: 'holystrike', desc: 'Holy Strike starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      {
        name: 'Marksmanship', school: 'nature', color: '#cdf5a8', nodes: [
          ...
          { id: 'h_m7', name: 'Mortal Shots', desc: '+9% crit damage per rank.', max: 6, effect: { critMult: 0.09 } },
          { id: 'h_m8', name: 'Careful Aim', desc: '+5% spell damage per rank.', max: 6, effect: { spellDamage: 0.05 } },
          { id: 'h_m9', name: 'Piercing Shots', desc: 'Shots punch through one more target per rank.', max: 2, effect: { pierce: 1 } },
          { id: 'h_m10', name: 'Rapid Killing', desc: '-4% cooldowns per rank.', max: 5, effect: { cooldownReduction: 0.04 } },
          { id: 'h_m11', name: 'Trueshot', desc: '+16% ranged damage and +1 extra projectile.', max: 1, effect: { spellDamage: 0.16, extraProjectiles: 1 } },
        ],
      },
      {
        name: 'Beast Mastery', school: 'nature', color: '#9dcf7a', nodes: [
          ...
          { id: 'h_b7', name: 'Ferocity', desc: '+8% pet power per rank.', max: 6, effect: { petPower: 0.08 } },
          { id: 'h_b8', name: 'Frenzy', desc: '+6% attack speed per rank.', max: 5, effect: { attackSpeed: 0.06 } },
          { id: 'h_b9', name: 'Bestial Wrath', desc: '+5% all damage per rank.', max: 5, effect: { allDamage: 0.05 } },
          { id: 'h_b10', name: 'Kindred Spirits', desc: '+16 max focus and +2 focus regen per rank.', max: 5, effect: { resourceMax: 16, resourceRegen: 2 } },
          { id: 'h_b11', name: 'Beast Within', desc: '+25% pet power, +1 beast and +10% all damage.', max: 1, effect: { petPower: 0.25, maxPets: 1, allDamage: 0.10 } },
        ],
      },
      {
        name: 'Survival', school: 'frost', color: '#8fe3ff', nodes: [
          ...
          { id: 'h_s7', name: 'Wyvern Sting', desc: '+9% damage over time per rank.', max: 5, effect: { dotDamage: 0.09 } },
          { id: 'h_s8', name: 'Survivalist', desc: '+18 max health and +2% dodge per rank.', max: 5, effect: { maxHp: 18, dodge: 0.02 } },
          { id: 'h_s9', name: 'Explosive Shot', desc: '+8% area radius per rank.', max: 5, effect: { aoeRadius: 0.08 } },
          { id: 'h_s10', name: 'Deterrence', desc: '-2.5% damage taken per rank.', max: 5, effect: { damageReduction: 0.025 } },
          { id: 'h_s11', name: 'Lone Wolf', desc: '+18% ranged damage and +10% move speed.', max: 1, effect: { spellDamage: 0.18, moveSpeed: 0.10 } },
        ],
      },
      // Mastery. Every node here names one skill and does nothing at all unless
      // that skill is one of your four.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'h_y2', name: 'Barrage', skill: 'multishot', desc: 'Multi-Shot hits harder and its cooldown drops 9%, per rank.', max: 5, effect: { skillDamage: 0.08, skillCooldown: 0.09 } },
          { id: 'h_y3', name: 'Lingering Venom', skill: 'serpentsting', desc: "Serpent's Sting poisons harder and 1s longer, per rank.", max: 5, effect: { skillDamage: 0.09, skillDuration: 1 } },
          ...
          { id: 'h_y6', name: 'Executioner', skill: 'killshot', desc: 'Kill Shot starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.14 } },
          { id: 'h_y7', name: 'Pack Leader', skill: 'summonbeast', desc: 'Call Beast is stronger and costs 12% less, per rank.', max: 4, effect: { skillDamage: 0.08, skillCost: 0.12 } },
          { id: 'h_y8', name: 'Bounding Leap', skill: 'disengage', desc: 'Disengage reaches 14% further and its cooldown drops 9%, per rank.', max: 4, effect: { skillRadius: 0.14, skillCooldown: 0.09 } },
          { id: 'h_y9', name: 'Hawk\'s Focus', skill: 'aspect', desc: 'Aspect of the Hawk lasts 2s longer and costs 12% less, per rank.', max: 4, effect: { skillDuration: 2, skillCost: 0.12 } },
          { id: 'h_y10', name: 'Iron Jaws', skill: 'freezingtrap', desc: 'Freezing Trap lasts 1.5s longer and reaches 12% further, per rank.', max: 4, effect: { skillDuration: 1.5, skillRadius: 0.12 } },
          { id: 'h_y11', name: 'Steady Focus', skill: 'steadyshot', desc: 'Steady Shot starts at rank 3 and hits harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
