    ...
    talents: [
      ...
      },
      {
        name: 'Fury', school: 'physical', color: '#ff9d5c', nodes: [
          ...
          { id: 'w_f10', name: 'Recklessness', desc: '+6% crit damage and -3% damage reduction per rank.', max: 4, effect: { critMult: 0.06 } },
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'w_m7', name: 'Leap of Faith', skill: 'heroicleap', desc: 'Heroic Leap hits 18% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.07, skillRadius: 0.12 } },
          ...
          { id: 'w_m9', name: 'Whirling Death', skill: 'bladestorm', desc: 'Bladestorm hits 20% harder and reaches 14% further, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.14 } },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'm_m7', name: 'Orbital Decay', skill: 'arcaneorb', desc: 'Arcane Orb hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          { id: 'm_m8', name: 'Conflagration', skill: 'flamestrike', desc: 'Flamestrike burns 22% harder and 1s longer, per rank.', max: 4, effect: { skillDamage: 0.08, skillDuration: 1 } },
          ...
          { id: 'm_m11', name: 'Deep Freeze', skill: 'frostbolt', desc: 'Frostbolt starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'k_m7', name: 'Rupture', skill: 'shadowfury', desc: 'Shadowfury hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'k_m11', name: 'Green Fire', skill: 'felflame', desc: 'Fel Flame starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 's_m7', name: 'Fracture', skill: 'earthshock', desc: 'Earth Shock hits 20% harder and costs 12% less, per rank.', max: 4, effect: { skillDamage: 0.08, skillCost: 0.12 } },
          { id: 's_m8', name: 'Thunderfist', skill: 'stormstrike', desc: 'Stormstrike hits 22% harder and its cooldown drops 8%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.08 } },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'p_m7', name: 'Guiding Star', skill: 'divinestar', desc: 'Divine Star hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'p_m9', name: 'Sanctify', skill: 'holyword', desc: 'Holy Word heals 22% more and reaches 12% further, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'r_m7', name: 'Fan of Knives', skill: 'shuriken', desc: 'Shuriken Toss hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'r_m11', name: 'Find Weakness', skill: 'backstab', desc: 'Backstab starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'd_m7', name: 'Rending Glaive', skill: 'glaivethrow', desc: 'Throw Glaive hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'd_m9', name: 'Fel Wave', skill: 'feldevastation', desc: 'Fel Devastation hits 22% harder and its cooldown drops 8%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.08 } },
          ...
          { id: 'd_m11', name: 'Cleave the Weak', skill: 'shear', desc: 'Shear starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      ...
      // your character better, this one makes a *build*.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'l_m7', name: 'Hands of Mercy', skill: 'layonhands', desc: 'Lay on Hands heals 22% more and its cooldown drops 9%, per rank.', max: 4, effect: { skillDamage: 0.08, skillCooldown: 0.09 } },
          { id: 'l_m8', name: 'Ricochet', skill: 'avengershield', desc: 'Avenger\'s Shield hits 20% harder and 12% wider, per rank.', max: 4, effect: { skillDamage: 0.08, skillRadius: 0.12 } },
          ...
          { id: 'l_m11', name: 'Hammer of the Just', skill: 'holystrike', desc: 'Holy Strike starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
    ...
    talents: [
      ...
      // that skill is one of your four.
      {
        name: 'Mastery', school: 'holy', color: '#ffd24a', nodes: [
          ...
          { id: 'h_y7', name: 'Pack Leader', skill: 'summonbeast', desc: 'Call Beast is 22% stronger and costs 12% less, per rank.', max: 4, effect: { skillDamage: 0.08, skillCost: 0.12 } },
          ...
          { id: 'h_y11', name: 'Steady Focus', skill: 'steadyshot', desc: 'Steady Shot starts at rank 3 and hits 30% harder.', max: 1, effect: { startRank: 3, skillDamage: 0.12 } },
        ],
      },
    ],
  },
